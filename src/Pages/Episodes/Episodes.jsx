...
const Episodes = ({ isEpisodes }) => {
    ...
    const handleToggleFavorite = (episode) => {
        ...
        if (favoriteEpisodes.includes(episodeId)) {
            setFavoriteEpisodes(prevFavoriteEpisodes => prevFavoriteEpisodes.filter(id => id !== episodeId));
        } else {
        ...
        <section className='episodes'>
            ...
            <div className="wrapper">
                            ...
                            <div className="episodes__box-container">
                                <div className="episodes__box-info">
                                    ...
                                    <button onClick={() => handleToggleFavorite(episode)} className='episodes__box-info__btn'>
                                        {favoriteEpisodes.includes(episode.id) ? "Remove" : "Add to watch list"}
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <FilterNotFound
                    ...
                    text="Sorry, but there are simply no quiet episode"
                />
